...
sed -ie "\$ahttp://dl-cdn.alpinelinux.org/alpine/v3.20/main" /etc/apk/repositories
sed -ie "\$ahttp://dl-cdn.alpinelinux.org/alpine/v3.20/community" /etc/apk/repositories
apk update
