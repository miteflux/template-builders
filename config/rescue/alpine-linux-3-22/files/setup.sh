...
apk add --no-cache py3-netifaces py3-pyserial cloud-init cloud-utils xfsprogs ntfs-3g ntfs-3g-progs btrfs-progs testdisk mc 7zip curl qemu-guest-agent e2fsprogs e2fsprogs-extra libblockdev lsblk parted sfdisk sgdisk eudev mount
