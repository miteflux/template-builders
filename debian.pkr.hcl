variables {
  ...
  iso_12               = "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.7.0-amd64-netinst.iso"
  iso_12_checksum      = "8fde79cfc6b20a696200fc5c15219cf6d721e8feb367e9e0e33a79d1cb68fa83"
...
build {
  sources = [
    ...
    "source.qemu.base-12-x86_64", "source.qemu.base-12-aarch64"
  ]
